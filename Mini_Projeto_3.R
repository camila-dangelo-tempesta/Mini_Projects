...
setwd("C:/repos/Microsoft_Power_BI_DataScienceAcademy/Modulo_III/Capitulo_15")
getwd()
...
# Renomeando colunas categÛricas
colnames(dados_clientes)
...
# Convertendo a variavÈl para o tipo fator com faixa et·ria
...
# Plot para ver a distribuiÁ„o do treinamento vs original
...
# Calculando Precision, Recall e F1-Score, mÈtricas de avaliaÁ„o do modelo preditivo
